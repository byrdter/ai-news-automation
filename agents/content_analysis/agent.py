...
_content_analysis_agent = None

def get_content_analysis_agent():
    """Get or create the content analysis agent (lazy initialization)."""
...
class ContentAnalysisService:
    ...
    def __init__(self):
        ...
        self.cohere_client = cohere.Client(self.settings.cohere_api_key.get_secret_value())
    ...
    async def analyze_content(self, request: AnalysisRequest) -> AnalysisResponse:
        ...
        try:
            ...
            analysis = ContentAnalysis(
                ...
                analysis_model=self.settings.cohere_model
            )
            ...
            analysis.analysis_model = self.settings.cohere_model
